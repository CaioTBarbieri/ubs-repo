...
public class AgendamentoController {
    ...
    public ResponseEntity<Agendamento> criarAgendamento(@RequestBody Map<String, Object> request) {
        try {
            ...
            Agendamento agendamento = agendamentoService.criarAgendamento(pacienteId, medicoId, dataHora, tipoConsulta,
                    observacoes);
    ...
    @PutMapping()
    public ResponseEntity<Agendamento> editarAgendamento(@RequestBody AgendamentoInput agendamentoAtualizado) {
        try {
    ...
    public ResponseEntity<Agendamento> atualizarObservacoes(@PathVariable Long id,
            @RequestBody Map<String, String> request) {
        try {
